	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>Find duplicates for 1500000 Sales Records</title>
			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="Find_x0020_duplicates_x0020_for_x0020_1500000_x0020_Sales_x0020_Records">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="Units_x0020_Sold"/>
								</td>
								<td>
									<xsl:value-of select="Unit_x0020_Cost"/>
								</td>
								<td>
									<xsl:value-of select="Unit_x0020_Price"/>
								</td>
								<td>
									<xsl:value-of select="Total_x0020_Profit"/>
								</td>
								<td>
									<xsl:value-of select="Order_x0020_Date"/>
								</td>
								<td>
									<xsl:value-of select="Ship_x0020_Date"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
